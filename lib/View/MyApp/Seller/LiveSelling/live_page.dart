...
import '../../../../utiles/CoustomWidget/Page_devided/add_to_cart_bottom_sheet.dart';
import 'package:era_shop/utiles/Strings/strings.dart';
import '../../../../utiles/Theme/my_colors.dart';
import '../../../../utiles/Zego/ZegoUtils/zegocloud_token.dart';
import '../../../../utiles/Zego/key_center.dart';
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: GoogleFonts.plusJakartaSans(
                                color: MyColors.primaryRed, fontSize: 16, fontWeight: FontWeight.w500),
                          ),
                        ),
                      ).paddingOnly(top: 12),
                    ),
          ...
          child: Stack(
            children: [
              ...
              Builder(builder: (context) {
                ...
                return Center(child: Text(St.youAreSharingYourScreen.tr, style: TextStyle(color: Colors.white)));
              }),
              widget.isHost
                  ? SizedBox(
                      height: Get.height,
                                                  ...
                                                  () => ListView.builder(
                                                    ...
                                                    itemBuilder: (context, index) {
                                                      Map<String, dynamic> commentMap =
                                                          jsonDecode(SocketManage.comments[index]);
                                                      return Row(
                                                          ...
                                                          Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                                ...
                                                                image: DecorationImage(
                                                                    image: NetworkImage(commentMap["image"]))),
                                              ...
                                              () => liveSellerForSellingController.isLoading.value
                                                  ...
                                                  : SizedBox(
                                                      ...
                                                      child: ListView.builder(
                                                        physics: const BouncingScrollPhysics(),
                                                        itemCount: liveSellerForSellingController
                                                            .sellerSelectedProducts.length,
                                                        itemBuilder: (context, index) {
                                                          var selectedProduct =
                                                              liveSellerForSellingController.sellerSelectedProducts;
                                                          return Padding(
                                                                ...
                                                                children: [
                                                                  ClipRRect(
                                                                    ...
                                                                    child: CachedNetworkImage(
                                                                      ...
                                                                      fit: BoxFit.cover,
                                                                      imageUrl:
                                                                          selectedProduct[index].mainImage.toString(),
                                            ...
                                            child: Obx(
                                              () => userGetSelectedProductController.isLoading.value
                                                  ...
                                                  : SizedBox(
                                                      ...
                                                      child: ListView.builder(
                                                        physics: const BouncingScrollPhysics(),
                                                        itemCount: userGetSelectedProductController
                                                            .userGetSelectedProduct!.data!.selectedProducts!.length,
                                                        itemBuilder: (context, index) {
                                                          var selectedProduct = userGetSelectedProductController
                                                              .userGetSelectedProduct!.data!.selectedProducts![index];
                                                          return Padding(
                                                            padding: const EdgeInsets.symmetric(vertical: 5),
                                                            child: InkWell(
                                                              onTap: () {
    ...
    return ZegoExpressEngine.instance
      ...
      if (loginRoomResult.errorCode == 0) {
        ...
        ScaffoldMessenger.of(context)
            .showSnackBar(SnackBar(content: Text('${St.loginRoomFailed.tr} ${loginRoomResult.errorCode}')));
      }
