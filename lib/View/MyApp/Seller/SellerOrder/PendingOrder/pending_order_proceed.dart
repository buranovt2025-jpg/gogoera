  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          height: 58,
                          decoration:
                              BoxDecoration(color: MyColors.primaryGreen, borderRadius: BorderRadius.circular(24)),
                          child: Center(
                            child: Text(
        ...
        Obx(() =>
            updateStatusWiseOrderController.isLoading.value ? ScreenCircular.blackScreenCircular() : const SizedBox())
      ],
    );
  }
}
