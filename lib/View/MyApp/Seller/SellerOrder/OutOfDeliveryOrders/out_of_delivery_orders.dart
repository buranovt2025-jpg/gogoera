...
class OutOfDeliveryOrders extends StatefulWidget {
  ...
  final String? status;
  const OutOfDeliveryOrders({Key? key, this.startDate, this.endDate, this.status}) : super(key: key);
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: GeneralTitle(title: St.outOfDeliveredOrder.tr),
                    ),
                  ),
                ],
              ),
                                          ...
                                          children: [
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                ...
                                                updateStatusWiseOrderController.itemId =
                                                ...
                                                Get.to(
                                                    () => OutOfDeliveryOrdersDetails(
                                                          productImage:
                                                              orders.items![index].productId!.mainImage,
                                                          productName:
                                                              orders.items![index].productId!.productName,
