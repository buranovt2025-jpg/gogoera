                          ...
                          children: [
                            ...
                            CoolDropdown<String>(
                              ...
                              defaultItem: CoolDropdownItem<String>(
                                value: '',
                                label: sellerProductDetailsController
                                    .sellerProductDetails!.product![0].category!.name
                                    .toString(),
                              ),
                              ...
                              resultOptions: ResultOptions(
                                  ...
                                  openBoxDecoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(26),
                                      border: Border.all(color: Colors.pink, width: 1.8))),
                              dropdownOptions: DropdownOptions(
                                  borderRadius: BorderRadius.circular(10),
                                  top: 10,
                                  height: 325,
                                  gap: const DropdownGap.all(5),
                                  borderSide: BorderSide(color: MyColors.mediumGrey),
                                  color: isDark.value ? MyColors.blackBackground : MyColors.dullWhite,
                              ...
                              dropdownItemOptions: DropdownItemOptions(
                                ...
                                selectedBoxDecoration:
                                    BoxDecoration(color: MyColors.primaryPink.withOpacity(0.20)),
                                isMarquee: true,
                            ...
                            const SizedBox(height: 15),
                            Wrap(
                              children: attributesAddProductController.attributeAddProduct!.attributes!
                                  .map((attributes) {
                                            ...
                                            headerBuilder: (BuildContext context, bool isExpanded) {
                                              return Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  border: Border.all(
                                                      ...
                                                      color: isDark.value
                                                          ...
                                                          : Colors.transparent),
                                                  color:
                                                      isDark.value ? MyColors.blackBackground : MyColors.dullWhite,
                                                ),
                                                child: sellerProductDetailsController
                                                  ...
                                                  itemBuilder: (context, index) {
                                                    print(
                                                        "selectedValuesByType${   sellerProductDetailsController
                              ...
                              child: PrimaryPinkButton(
                                  onTaped: () {
                                    ...
                                    editProductController.editCatalog(
                                      ...
                                      productName:
                                          addProductController.nameController.text.capitalizeFirst.toString(),
