                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var sellerEarningAmount =
                            sellerTotalEarningController.sellerTotalEarning!.sellerEarningAmount;
                        return Container(
                          height: 77,
                            ...
                            child: Row(
                              children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: GoogleFonts.plusJakartaSans(
                                              color: MyColors.darkGrey, fontSize: 11, fontWeight: FontWeight.w500),
                                        ),
                                      ],
                                    ),
                                  ),
                                ...
                                Container(
                                  height: 35,
                                  decoration: BoxDecoration(
                                      color: MyColors.primaryGreen, borderRadius: BorderRadius.circular(50)),
                                  child: Center(
                                    child: Padding(
                                      padding: const EdgeInsets.symmetric(horizontal: 25),
                                      child: Text("${sellerEarningAmount[index].amount}",
                                          style: GoogleFonts.plusJakartaSans(
                                              color: MyColors.white, fontWeight: FontWeight.w600, fontSize: 13.6)),
                                    ),
                                  ),
                                ),
                              ],
