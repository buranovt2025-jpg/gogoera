    ...
    if (passwordValidate.isFalse && passwordLength.isFalse && confirmPasswordValidate.isFalse && confirmPasswordLength.isFalse) {
      if (userChangePassword.text == userChangeConfirmPassword.text) {
        try {
          ...
          var data = await UpdatePasswordService().updatePasswordApi(
              oldPass: userOldPassword.text, newPass: userChangePassword.text, confirmPass: userChangeConfirmPassword.text);
          updatePassword = data;
      ...
      if (createNewPassword.text == createNewConfirmPassword.text) {
        try {
          ...
          await apiCreatePasswordController.getNewPasswordData(
              email: enterEmail.text, newPassword: createNewPassword.text, confirmPassword: createNewConfirmPassword.text);
