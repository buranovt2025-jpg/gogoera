  ...
  increment() {
    setState(() {
      ...
      addProductToCartController
          ...
          .then((value) => getAllCartProductController.getCartProductData(updatedData: true));
    });
  }
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () async {
                        productId = widget.productId;
                        await removeProductToCartController
                            .removeProductToCartData(
                                productQuantity: widget.productQuantity, attributes: widget.attributesArray)
                            .then((value) => getAllCartProductController.getCartProductData(updatedData: true));
                        Get.back();
                      },
                      child: Container(
                        height: 50,
                        width: Get.width * 0.3,
                        decoration: BoxDecoration(color: MyColors.primaryPink, borderRadius: BorderRadius.circular(16)),
                        child: Center(
                          child: Obx(
                        ...
                        child: Row(
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Obx(
                                () => Center(
                                  child: getAllCartProductController.updateLoading.value ||
                                ...
                                ? Container(
                                    ...
                                    child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                      ...
                                      Container(
                                        height: 20,
                                        width: 20,
                                        decoration: BoxDecoration(color:  Color(int.parse(attribute["value"].replaceAll("#", "0xFF"))), shape: BoxShape.circle),
                                      )
                                    ]),
                                  )
                                : Container(
                                    ...
                                    child: RichText(
                                      text: TextSpan(
                                        children: [
                                          ...
                                          TextSpan(
                                            text: '${attribute["value"]}'.toUpperCase(),
                                            style: GoogleFonts.plusJakartaSans(
                                                fontWeight: FontWeight.w500, color: MyColors.primaryPink),
                                          ),
                                        ],
