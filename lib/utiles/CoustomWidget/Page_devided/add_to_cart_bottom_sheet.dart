                                        ...
                                        child: CoolDropdown<String>(
                                          ...
                                          onChange: (value) async {
                                            if (dropdownController.isError) {
                                              ...
                                              setState(() {
                                                ...
                                                List<Map<String, String>> selectedValueList = addProductToCartController
                                          ...
                                          resultOptions: ResultOptions(
                                            ...
                                            boxDecoration: BoxDecoration(
                                              border: Border.all(color: isDark.value ? MyColors.darkGrey : MyColors.mediumGrey),
                                            ...
                                            placeholderTextStyle: GoogleFonts.plusJakartaSans(
                                                color: Colors.grey.shade400, fontSize: 15.3, fontWeight: FontWeight.w600),
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Container(
                                  height: 58,
                                  decoration: BoxDecoration(
                                      color: areAllAttributesFilled == false
                                          ? MyColors.darkGrey.withOpacity(0.40)
