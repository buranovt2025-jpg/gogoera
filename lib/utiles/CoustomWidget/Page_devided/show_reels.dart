    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
                                ...
                                child: SizedBox(
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Text(
                                      ...
                                      overflow: getReelsForUserController.isTextExpanded.value
                            ...
                            () => Column(
                              children: [
                                Image.asset(
                                  ...
                                  height: 33,
                                  color: isLike.value ? Colors.red : MyColors.white,
                                ).paddingOnly(bottom: 4),
                                Text(
                                  "${likeCount.value}",
                                  style: GoogleFonts.plusJakartaSans(
                                      fontSize: 12, fontWeight: FontWeight.w700, color: MyColors.white),
                                )
                              ],
                            ),
                          )),
          ...
          //               height: 55,
          //               width: 55,
          //               decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.black.withOpacity(0.60)),
          //               child: const Center(
          //                 child: SizedBox(
          //                   height: 25,
          //                   width: 25,
