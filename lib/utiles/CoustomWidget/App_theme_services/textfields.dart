...
import 'package:era_shop/utiles/CoustomWidget/Page_devided/filter_bottem_shit.dart';
...
//                 borderSide: BorderSide(color: MyColors.primaryPink), borderRadius: BorderRadius.circular(30))),
//       ),
//     ),
//   );
// }
              ...
              child: GetBuilder<SellerCommonController>(
                builder: (controller) => TextFormField(
                  onTap: (controllerType == "ReelsSelectProduct")
                      ? () {
                          Get.bottomSheet(isScrollControlled: true, const SelectProductWhenCreateReels());
                      ...
                      : onTap,
                  textCapitalization:
                      (controllerType == "IFSC") ? TextCapitalization.characters : TextCapitalization.none,
                  ...
                  readOnly: (controllerType == "eMail") ||
                      ...
                      ? true
                      : readOnly,
                  keyboardType: (controllerType == "Pincode") ||
                          (controllerType == "AccountNumber") ||
                          (controllerType == "ProductPrice") ||
                          (controllerType == "MinimumOrder") ||
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: GoogleFonts.plusJakartaSans(
                        color: (controllerType == "ReelsBusinessName")
                            ? isDark.value
                                ? MyColors.white
                                : MyColors.black
                            : Colors.grey.shade400,
                        fontSize: 16),
                    suffixIcon: (controllerType == "ReelsSelectProduct")
                        ? const Icon(Icons.keyboard_arrow_down_outlined)
                        : suffixIcon,
                    focusedBorder: readOnly ? InputBorder.none : const OutlineInputBorder(),
                    enabledBorder: OutlineInputBorder(
                        borderSide: isDark.value ? BorderSide(color: Colors.grey.shade800) : BorderSide.none,
                        borderRadius: BorderRadius.circular(26)),
                    // border: OutlineInputBorder(
        ...
        : (controllerType == "BusinessTag")
            ...
            : (controllerType == "eMail")
                ...
                : (controllerType == "Address")
                    ? sellerCommonController.addressController
                        ...
                        : (controllerType == "City")
                            ...
                            : (controllerType == "Pincode")
                                ...
                                : (controllerType == "bankBusinessName")
                                    ...
                                    : (controllerType == "AccountNumber")
                                        ? sellerCommonController.accountNumberController
                                        : (controllerType == "IFSC")
                                                                                        ...
                                                                                        : (controllerType == "ZipCode")
                                                                                            ...
                                                                                            : (controllerType ==
                                                                                                ...
                                                                                                : (controllerType ==
                                                                                                    ...
                                                                                                    : (controllerType ==
                                                                                                            "TrackingId")
                                                                                                        ? updateStatusWiseOrderController
                  ...
                  decoration: InputDecoration(
                      errorText: (sellerController.passwordValidate.value && widget.controllerType == "Password")
                          ...
                          : (sellerController.passwordLength.value && widget.controllerType == "Password")
                              ...
                              : (sellerController.oldPasswordValidate.value &&
                                      widget.controllerType == "SellerAddOldPassword")
                                  ? "Old password cannot be empty"
                                  : (sellerController.oldPasswordLength.value &&
                                          widget.controllerType == "SellerAddOldPassword")
                                      ? "Password must be 8 digits"
                                      : (sellerController.changePasswordValidate.value &&
                                              widget.controllerType == "SellerChangePassword")
                                          ? "Password cannot be empty"
                                          : (sellerController.changePasswordLength.value &&
                                                  widget.controllerType == "SellerChangePassword")
                                              ? "Password must be 8 digits"
                                              : (sellerController.confirmPasswordValidate.value &&
                                                      widget.controllerType == "SellerChangeConfirmPassword")
                                                  ? "Confirm password cannot be empty"
                                                  : (sellerController.confirmPasswordLength.value &&
                                                          widget.controllerType == "SellerChangeConfirmPassword")
                                                      ? "Confirm password must be 8 digits"
                                                      : (sellerController.createPasswordValidate.value &&
                                                              widget.controllerType == "SellerCreatePassword")
                                                          ? "Password cannot be empty"
                                                          : (sellerController.createPasswordLength.value &&
                                                                  widget.controllerType == "SellerCreatePassword")
                                                              ? "Password must be 8 digits"
                                                              : (sellerController.createConfirmPasswordValidate.value &&
                                                                      widget.controllerType ==
                                                                          "SellerCreateConfirmPassword")
                                                                  ? "Confirm password cannot be empty"
                                                                  : (sellerController
                                                                              .createConfirmPasswordLength.value &&
                                                                          widget.controllerType ==
                                                                              "SellerCreateConfirmPassword")
                                                                      ? "Confirm password must be 8 digits"
                                                                      : null,
            ...
            Padding(
              ...
              child: GetBuilder<UserPasswordController>(
                builder: (controller) => TextFormField(
                  ...
                  obscureText: _obscureText,
                  decoration: InputDecoration(
                      errorText: (changePasswordController.oldPasswordValidate.value &&
                              widget.controllerType == "oldPassword")
                          ? "Old Password cannot be empty"
                          : (changePasswordController.oldPasswordLength.value && widget.controllerType == "oldPassword")
                              ? "Password must be 8 digits"
                              : (changePasswordController.passwordValidate.value &&
                                      widget.controllerType == "changePassword")
                                  ? "Password cannot be empty"
                                  : (changePasswordController.passwordLength.value &&
                                          widget.controllerType == "changePassword")
                                      ? "Password must be 8 digits"
                                      : (changePasswordController.confirmPasswordValidate.value &&
                                              widget.controllerType == "changeConfirmPassword")
                                          ? "Confirm Password cannot be empty"
                                          : (changePasswordController.confirmPasswordLength.value &&
                                                  widget.controllerType == "changeConfirmPassword")
                                              ? "Confirm Password must be 8 digits"
                                              : (changePasswordController.createPasswordValidate.value &&
                                                      widget.controllerType == "UserCreatePassword")
                                                  ? "Password cannot be empty"
                                                  : (changePasswordController.createPasswordLength.value &&
                                                          widget.controllerType == "UserCreatePassword")
                                                      ? "Password must be 8 digits"
                                                      : (changePasswordController.createConfirmPasswordValidate.value &&
                                                              widget.controllerType == "UserCreateConfirmPassword")
                                                          ? "Confirm Password cannot be empty"
                                                          : (changePasswordController
                                                                      .createConfirmPasswordLength.value &&
